...
namespace Game_Project_1.Sprites
{
    ...
    public class MushroomSprite
    {
        ...
        public void Respawn()
        {
            Position.X = rng.Next(13, 790);
            Position.Y = rng.Next(190, 460);
        }
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            */
            ...
            _bounds = new BoundingRectangle(new Vector2(Position.X - 15 + 1.39f, Position.Y - 1.39f), 15 * 1.485f, 15 * 1.485f);
            ...
            if (Closeness < 105)
            {
                _antiCloseness = (105 - (int)Closeness);
                _color = new Color(_antiCloseness * 3, _antiCloseness * 3, _antiCloseness * 3);
            }
            else
            {
            ...
            spriteBatch.Draw(_texture, Position, source, _color, 0, new Vector2(8, 0), (float)1.485, SpriteEffects.None, 1);
        }
    }
}
